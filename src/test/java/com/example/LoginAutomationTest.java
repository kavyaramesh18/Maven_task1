...
class LoginAutomationTest {
    ...
    static void setup() {
        ...
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\Kavyashree\\Downloads\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe"); // Correct path for ChromeDriver
